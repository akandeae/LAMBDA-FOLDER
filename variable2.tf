...
variable "cluster_security_group" {
  description = "additional security group name"
  type        = string
  default     = null
}
...
variable "apply_manifests" {
  default     = false
  description = "Installs Istio Gateway through Helm"
  type        = bool
}
variable "manifest_files_source" {
  description = "Manifest YAML FIle"
  default     = ""
  type        = string

}
variable "cluster_files" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}

variable "canary_files" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "manifest_files_template_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "cert_manager_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "aws-load-balancer_controller_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "aws-load-balancer-controller_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "aws_efs_csi_driver_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "aws_efs_csi_driver_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "external_secrets_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "external_secrets_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "istio_gw_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "istio_gw_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "kiali-operator" {
  description = "Customize cert-manager chart, see `cert-manager.tf` for supported values"
  type        = any
  default     = {}
}
variable "kiali_operator_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "kiali_operator_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "jaeger_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "jaeger_stack_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "flagger_values_file" {
  description = "Customize loki-stack chart, see `loki-stack.tf` for supported values"
  type        = string
  default     = ""
}
variable "flagger_yaml_vars" {
  type        = map(any)
  default     = {}
  description = "To pass manifest variables"
}
...
variable "cni_version" {
  description = "CNI eks addon version"
  type        = string
  default     = ""
}
